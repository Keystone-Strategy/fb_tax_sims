import_usa_mau_data <- function() {
  ...
  mau_pre_2011  <- data.table(read.xlsx(file.path(input_fld, "1. FBDIS00060473.xlsx"), sheet = "Worksheet" ))
  mau_post_2011 <- data.table(read.xlsx(file.path(input_fld, "2. FBDIS00060474.xlsx"), sheet = "Data"      ))
  # Subset the datasets
