import_youtube_maus <- function() {
  ...
  youtube_2011_2016_users <- data.table(read.xlsx(file.path(input_fld, "YouTube_US_Users_2011_2016.xlsx"), "Users"))
  # Load in the 2017 to 2019 YouTube users
  youtube_2017_2019_users <- data.table(read.xlsx(file.path(input_fld, "Statista_YouTube_US_MAUs_2017_2019.xlsx"), "Data"))
